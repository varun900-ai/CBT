...
public class ViewResults extends javax.swing.JFrame {
    ...
    public ViewResults() {
        ...
        String [] columns  = {"Id", "Roll no", "Name", "Branch", "Year", "MARKS"};
        //  columa k name zero  wale row mai show hoge
        ...
        try
        {
            ...
            { // while begin
                ...
                String [] data = {id , rollno, name, branch, year, marks};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VIEW - ALL - RESULTS");
